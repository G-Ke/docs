...
- Collaborated cross-functionally with Sales, Implementation, Engineering, and external stakeholders to efficiently resolve bugs and client issues with integrations.
...
- Spearheaded technical projects and eliminated account-related obstacles through direct customer collaboration.

- Leveraged a diverse toolset including Splunk, Postman, Jira, browser devtools, and proprietary software to diagnose and resolve complex technical issues.

- Implemented and configured crucial integrations including customer SSO, proxy network routing, and GitHub repositories.

### Customer Support Lead
**Latch** 
*2020-2022*

- Established position as product expert for IoT and SaaS offerings, leading company-wide training initiatives.
...
- Resolved advanced technical issues through in-depth log analysis using Datadog, Twilio, and other specialized tools.

- Orchestrated cross-functional collaboration between Engineering and Product teams to streamline feedback processes, resulting in improved feature identification, tracking, implementation, and testing.
